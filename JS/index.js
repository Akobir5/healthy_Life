...
let textInfo = [
        {
            text_p: "Booking Health™ – самый крупный и прозрачный медицинский туристический сервис в мире. На нашем сайте представлены более 250 клиник в Австрии, Германии, Швейцарии, Индии, Коста-Рике, Турции, Таиланде, Польше, Венгрии, Израиле, ОАЭ, Южной Корее и Японии. До размещения на сайте клиника проходит тщательную проверку по количеству успешных и безопасных операций, уровню оснащенности, комфортности пребывания и другим показателям."
        },

        {
            text_p: "На сайте представлены свыше 700 000 медицинских программ на выбор клиента. Это программы базового и расширенного профилактического обследования (чек ап), индивидуальная диагностика в сложных клинических случаях, амбулаторное и стационарное лечение, реабилитация и СПА-отдых."
        },

        {
            text_p: "Наша цель – предоставить возможность пациентам из любой точки мира самостоятельно в режиме онлайн подобрать клинику, которая предлагает оптимальную для них медицинскую программу, видеть стоимость этой программы и заказать ее по лучшей цене. Для принятия наиболее выгодного для себя решения пациент и его родственники могут детально изучить информацию о сертификатах клиники, достижениях лечащего врача, методиках лечения и стоимости услуг."
        }, 

        {
            text_p: "При выборе между несколькими ведущими медицинскими учреждениями пациент может воспользоваться профессиональным советом наших врачей. Благодаря помощи медицинских специалистов Booking Health™ более 73 000 пациентов прошли необходимое лечение, включая инновационные методики, недоступные в их родной стране."
        },

        {
            text_p: "Мы заботимся об удобстве и спокойствии пациентов. После выбора медицинской программы мы помогаем с получением визы для пациента и сопровождающего лица, переводом медицинских документов, перелетом и проживанием, общением с иностранным врачом через переводчика, контролем стоимости медицинских услуг и бытовыми моментами. Наши пациенты застрахованы от осложнений во время лечения на сумму 200 000 €."
        },

        {
            text_p:"Компания Booking Health™ – единственный в мире оператор медицинского туризма, качество работы которого подтверждено престижным международным сертификатом ISO 9001:2015 в сфере лечения иностранных пациентов. Мы оказываем помощь пациентам из 75 стран, общаясь с ними на их родном языке."
        },

        {
            text_p: "Наша миссия – внести прозрачность в ценообразование и качество на рынке медицинского туризма, и предоставить пациентам из любой страны возможность комфортно пройти необходимое лечение за рубежом."
        }
]
